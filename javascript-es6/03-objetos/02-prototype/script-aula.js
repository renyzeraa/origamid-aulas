...
function Pessoa(nome, idade) {
  // função construtora, (parametros)
  this.nome = nome
  this.idade = idade
}

// Pessoa.prototype.
// a partir do ponto posso adicionar metodos e outras propriedades ao meu objeto principal

const andre = new Pessoa('André', 28)
// novo objeto = new objeto(argumentos)

console.log(Pessoa.prototype) // retorna o objeto
console.log(andre.prototype) // undefined por que não é uma função e sim um objeto
